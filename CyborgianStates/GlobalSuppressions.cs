...
[assembly: SuppressMessage("Design", "CA1031:Keine allgemeinen Ausnahmetypen abfangen", Justification = "<Ausstehend>", Scope = "member", Target = "~M:CyborgianStates.CommandHandling.NationStatesApiRequestQueue.ExecuteRequest(CyborgianStates.Interfaces.Request)~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Design", "CA1031:Keine allgemeinen Ausnahmetypen abfangen", Justification = "<Ausstehend>", Scope = "member", Target = "~M:CyborgianStates.Services.BotService.ProcessMessage(CyborgianStates.Interfaces.MessageReceivedEventArgs)~System.Threading.Tasks.Task")]
